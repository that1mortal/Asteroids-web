...
async def main():
    ...
    if first == True:
        while first:
            ...
            sub_text = SCORE_TEXT.render("You can pause by pressing Esc", 1, WHITE)
            ...
            shake_screen.blit(instructions_text_1, (SCREEN_WIDTH / 2 - instructions_text_1.get_width() / 2,
            ...
            shake_screen.blit(instructions_text_3, (SCREEN_WIDTH / 2 - instructions_text_3.get_width() / 2,
                                                    SCREEN_HEIGHT / 2 - instructions_text_3.get_height() / 2 - 200))
            ...
            shake_screen.blit(sub_text, (
                SCREEN_WIDTH / 2 - sub_text.get_width() / 2, SCREEN_HEIGHT / 2 - sub_text.get_height() / 2 - 110))
